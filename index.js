...
async function getRecipeDetails(id) {
    ...
    try {
       ...
       modalContent.innerHTML = '<p class="message error">Failed to load recipe details. Please check your connection or try again.</P>' 
    }
}
...
function displayRecipeDetails(recipe) {
    ...
    const youtubeHTML = recipe.strYoutube ? `<h3>Video Recipe</h3><div class="video__wrapper"><a href="${recipe.strYoutube}"
    target="_blank">Watch on YouTube.</a></div>`  : "" 
    const sourceHTML = recipe.strSource ? `<div class="source__wrapper"><a href="${recipe.strSource}" target="_blank">View Original Source.</a></div>` : ""
